<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNotification.aspx.cs" Inherits="newapp_AddNotification" %>
...
<a href="#" data-menu="menu-demo-modal-medium" class="button bg-highlight button-m  round-tiny">Change Operation</a>
    ...
    <caption class="style1">  
                    <strong><center>Recent Updates:</center></strong>  
    </caption>
                   
                  <%-- todays  date --%>
                  
<label class="contactEmailField color-theme" for="contactEmailField">Date And Time: </label>
                    <asp:Label  CssClass="header-icon header-icon-3" ID="LabelDate" runat="server"></asp:Label>
...
<label class="contactEmailField color-theme" for="contactEmailField">Related To: </label>
...
<%-- Discription--%>
                   <div class="form-field form-email">
<label class="contactEmailField color-theme" for="contactEmailField">Discription: </label>
        <asp:TextBox CssClass="contactField requiredField" id="TextArea1"  runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server"   
ControlToValidate="TextArea1" ErrorMessage="Please Enter Your Username"   
ForeColor="Red"></asp:RequiredFieldValidator> 
</div>
 <%-- End Discription--%>
<%-- Regards--%>
                   <div class="form-field form-email">
<label class="contactEmailField color-theme" for="contactEmailField">Regards: </label>
        <asp:TextBox CssClass="contactField requiredField" ID="TextBox3" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server"   
ControlToValidate="TextBox3" ErrorMessage="Please Enter Your Username"   
ForeColor="Red"></asp:RequiredFieldValidator> 
</div>
 <%-- End Regards--%>
...
<br /> 
   ...
   <asp:Button CssClass="button bg-highlight button-m button-full round-tiny" ID="Button1"  runat="server" Text="UPLOAD" onclick="Save_ServerClick" />  
             
                 <%--   End of button of uplaod--%>
