...
<body class="theme-light" data-highlight="blue2">
    ...
    <div id="page">
        ...
        <div class="page-content header-clear-medium">
            <div data-height="220" class="caption caption-margins round-medium shadow-large">
                <div class="caption-center">
                    <h1 class="center-text color-white bolder font-28">Galleries</h1>
                    <p class="boxed-text-large color-white opacity-80">
                        All possibilities of galleries, easy to use, just a copy and paste your photos.
                    </p>
                    <a href="index.html" class="button button-round-huge button-center-small button-xxs bg-highlight">Back Home</a>
                </div>
            ...
            <div class="content">
                <div class="link-list link-list-1 link-list-long-border">
                    ...
                    <a href="gallery-round.html"><i class="fa fa-square color-green1-dark"></i><span>Round</span><i class="fa fa-angle-right"></i></a>
                    <a href="gallery-square.html"><i class="fa fa-circle color-blue2-dark"></i><span>Square</span><i class="fa fa-angle-right"></i></a>
                    <a href="gallery-filterable.html"><i class="fa fa-th color-pink1-dark"></i><span>Filterable</span><i class="fa fa-angle-right"></i></a>
                    <a href="gallery-collections.html"><i class="fa fa-th-large color-mint-dark"></i><span>Collections</span><i class="fa fa-angle-right"></i></a>
                    <a href="gallery-wide-1.html"><i class="fa fa-bars color-red2-dark"></i><span>Wide Style Left</span><i class="fa fa-angle-right"></i></a>
                    <a href="gallery-wide-2.html"><i class="fa fa-bars color-brown2-dark"></i><span>Wide Style Center</span><i class="fa fa-angle-right"></i></a>
                    <a href="gallery-wide-3.html"><i class="fa fa-bars color-teal-dark"></i><span>Wide Style Mixed</span><i class="fa fa-angle-right"></i></a>
                </div>
            </div>
            <div data-height="220" class="caption caption-margins round-medium shadow-large">
                <div class="caption-center">
                    <h1 class="center-text color-white bolder font-28">Portfolios</h1>
                    <p class="boxed-text-large color-white opacity-80">
                        All possibilities of portfolios, easy to use, just copy & paste your projects.
                    </p>
                    <a href="index.html" class="button button-round-huge button-center-small button-xxs bg-highlight">Back Home</a>
                </div>
                <div class="caption-overlay bg-black opacity-80"></div>
                <div class="caption-bg bg-27"></div>
            </div>
            <div class="content">
                <div class="link-list link-list-1 link-list-long-border">
                    <div class="divider bottom-0"></div>
                    <a href="portfolio-instant.html"><i class="fa fa-bolt color-yellow1-dark"></i><span>Instant</span><i class="fa fa-angle-right"></i></a>
                    <a href="portfolio-one-1.html"><i class="fa fa-bars color-red2-dark"></i><span>One Column v1 </span><i class="fa fa-angle-right"></i></a>
                    <a href="portfolio-one-2.html"><i class="fa fa-bars color-green1-dark"></i><span>One Column v2 </span><i class="fa fa-angle-right"></i></a>
                    <a href="portfolio-one-3.html"><i class="fa fa-bars color-blue2-dark"></i><span>One Column v3 </span><i class="fa fa-angle-right"></i></a>
                    <a href="portfolio-two-1.html"><i class="fa fa-th-large color-magenta2-dark"></i><span>Two Columns v1</span><i class="fa fa-angle-right"></i></a>
                    <a href="portfolio-two-2.html"><i class="fa fa-th-large color-pink1-dark"></i><span>Two Columns v2</span><i class="fa fa-angle-right"></i></a>
                    <a href="portfolio-two-3.html"><i class="fa fa-th-large color-teal-dark"></i><span>Two Columns v3</span><i class="fa fa-angle-right"></i></a>
                    <a href="portfolio-selected.html"><i class="fa fa-star color-yellow1-dark"></i><span>Project Selected</span><i class="fa fa-angle-right"></i></a>
                </div>
            </div>
            <div class="footer">
