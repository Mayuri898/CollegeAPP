<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegistrationOfStaff.aspx.cs" Inherits="newapp_RegistrationOfStaff" %>
...
ForeColor="Red"></asp:RequiredFieldValidator> 
    ...
    <div class="form-field form-email">
        <label class="contactEmailField color-theme" for="contactEmailField">Unique Id : </label>
