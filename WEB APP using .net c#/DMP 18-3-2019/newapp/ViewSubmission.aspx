<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewSubmission.aspx.cs" Inherits="newapp_ViewSubmission" %>
...
<%--View Assignment--%>
  ...
  <%--list of assignments --%>
            ...
            <Columns>
                ...
                <asp:LinkButtonField ID="lbClose" runat="server" CausesValidation="False"  CommandName="CloseClicked" Text="Close" />
 <%--<asp:HyperLinkField 
            ...
            </Columns> NavigateUrl="./bids/" + cmdr2["bidd_name"].ToString();
        </asp:GridView>
