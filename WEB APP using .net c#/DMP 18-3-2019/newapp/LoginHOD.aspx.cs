...
public partial class newapp_LoginHOD : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("select * from RegisterDBHOD where Username=@Username and password=@password", con);
