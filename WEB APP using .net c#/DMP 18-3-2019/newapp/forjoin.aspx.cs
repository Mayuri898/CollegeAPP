...
public partial class newapp_forjoin : System.Web.UI.Page
{
    ...
    protected void Upload_ServerClick(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("insert into forjoin(id,Sem,Sub,UploadDate,SubmissionDate) values ((select isnull(max(id),0)+1 from forjoin),@Sem,@Sub,@UploadDate,@SubmissionDate)", con);
