<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AfterStudentLogin.aspx.cs" Inherits="newapp_AfterStudentLogin" %>
...
<body>
  ...
  <a href="#" class="nav-title color-theme"><span class="color-highlight">Devi Mahalaxmi Polytechnic</span>College</a>
    ...
    <div class="nav nav-medium">
      ...
      <div>     
      <asp:Button CssClass="button bg-highlight button-m button-full round-tiny" ID="Button1"  runat="server" Text="View List Of Assignments" onclick="Upload_ServerClick" />
       </div>
            <br />
        <div>  
          <asp:Button CssClass="button bg-highlight button-m button-full round-tiny" ID="Button2"  runat="server" Text="Add Submission" onclick="Upload1_ServerClick" />
      </div>
            <br />

          <div>  
            <asp:Button CssClass="button bg-highlight button-m button-full round-tiny" ID="Button3"  runat="server" Text="Notification" onclick="Upload2_ServerClick" />
        </div>
