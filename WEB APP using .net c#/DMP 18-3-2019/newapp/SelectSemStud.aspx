<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectSemStud.aspx.cs" Inherits="newapp_SelectSemStud" %>
...
<a href="#" data-menu="menu-demo-modal-medium" class="button bg-highlight button-m  round-tiny">Change Operation</a>
    ...
    <caption class="style1">  
                    <strong><center>ADD Submission</center></strong>  
    </caption>
                   
                  <%-- todays Submission date --%>
